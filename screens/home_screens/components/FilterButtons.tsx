        ...
        <XStack space={0} justifyContent='center' backgroundColor='#fff'>
            <StyledButton onPress={() => setFilter(filterOptions.all)}>
                <YStack alignItems="center" space={3}>
                    <Text color={filter === filterOptions.all ? '#000' : '#949494'} marginTop='$space.3' fontSize={40} fontWeight='700'>{docCount.all}</Text>
            ...
            <StyledButton pressStyle={{ borderBlockColor: '$color.accept' }} onPress={() => setFilter(filterOptions.toAgree)}>
                <YStack alignItems="center" space={3}>
                    <Text color={filter === filterOptions.toAgree ? '#000' : '#949494'} marginTop='$space.3' fontSize={40} fontWeight='700'>{docCount.toAgree}</Text>
            ...
            <StyledButton onPress={() => setFilter(filterOptions.archive)}>
                <YStack alignItems="center" space={3}>
                    <Text color={filter === filterOptions.archive ? '#000' : '#949494'} marginTop='$space.3' fontSize={40} fontWeight='700'>{docCount.archive}</Text>
